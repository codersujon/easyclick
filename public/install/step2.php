...
<section class="flex flex-col justify-center antialiased bg-gray-200 text-gray-600 min-h-screen p-4">
    <div class="h-full">
        ...
        <div class="max-w-[556px] mx-auto">
            <div class="bg-white shadow-lg rounded-lg mt-9 py-4">
                <!-- card header -->
                       ...
                       <!-- check the requirments is true or false -->
                        <?php if($passed == '1111'): ?>
                            ...
                            <?php else: ?>
                                ...
                                Sorry. The requirements of HasnaGlow is not available on your server. Please contact with us- support@hasnaglow.com with this code- <?php echo $passed; ?> Or contact with your server administrator.
                                </h4>
                                <a href="#" class="font-semibold text-sm items-center justify-center px-3 py-2 border border-transparent rounded leading-5 shadow transition duration-150 ease-in-out w-full bg-red-500 hover:bg-red-600 text-white focus:outline-none focus-visible:ring-2 border-l">Correct The Problem To Continue</a>
