...
{{-- 
                        ...
                        <li><a class="{{setActive(['best_product'])}}" href="{{route('all_product')}}">All Products</a></li>
                        <li><a class="{{setActive(['flash-sale'])}}" href="{{route('flash-sale')}}">flash Sale</a></li>
                        <li><a class="{{setActive(['new_arrival'])}}" href="{{route('new_arrival')}}">New Arrival</a></li>
                        <li><a class="{{setActive(['top_product'])}}" href="{{route('top_product')}}">Top Product</a></li>
                        <li><a class="{{setActive(['best_product'])}}" href="{{route('best_product')}}">Best Product</a></li>
