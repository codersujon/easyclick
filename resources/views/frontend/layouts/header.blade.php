...
<header style="background: #2A8B00 !important;">
    <div class="container" >
        <div class="row">
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area">
                    <a class="wsus__header_logo" href="{{url('/')}}">
                        <img  style="margin-top: -5vh;" src="{{asset(@$logoSetting->logo)}}" alt="logo" class="img-fluid w-100  pb-5">
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        ...
                        <li style="z-index: 9999"><a class="wsus__cart_icon shopping-bag" href="#"><i
